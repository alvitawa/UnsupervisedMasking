...
# from torch.optimizer import Optimizer, required, _use_grad_for_differentiable


class ConstantWD_SGD(SGD):
...
def _multi_tensor_sgd(params: List[Tensor],
    ...
    if weight_decay != 0:
        grads = torch._foreach_add(grads, weight_decay)
