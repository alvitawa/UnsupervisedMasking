...
# Create a masked version of the model, using the default settings of a threshold of 0 and score initialization
model = submasking.SubmaskedModel(model, parameter_selection=par_sel, scores_init=scores_init)
